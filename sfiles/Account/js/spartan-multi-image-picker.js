...
(function ($) {
    ...
    $.fn.spartanMultiImagePicker = function(options) {
        ...
        function addRow(settings, el){
            ...
            var template = `<center><div class="${groupClassName} spartan_item_wrapper" data-spartanindexrow="${count}>`+
                                `<div style="position: relative; width: 250px;">`+
                                    `<div class="spartan_item_loader" data-spartanindexloader="${count}" style=" position: absolute; width: 50%; height: ${rowHeight}; background: rgba(255,255,255, 0.7); z-index: 22; text-align: center; align-items: center; margin: auto; justify-content: center; flex-direction: column; display : none; font-size : 1.7em; color: #CECECE">` +
                                        `${uploadLoaderIcon}` +
                                    `</div>`+
                                    `<label class="file_upload" style="width: 70%; height: ${rowHeight}; border: 2px dashed #ddd; border-radius: 3px; cursor: pointer; text-align: center; overflow: hidden; padding: 5px; margin-top: 5px; margin-bottom : 5px; position : relative; display: flex; align-items: center; margin: auto; justify-content: center; flex-direction: column;">`+
                                        ...
                                        `<img style="width: 100%; height: 100%; vertical-align: middle; display:none;" class="img_ rounded-circle" data-spartanindeximage="${count}">`+
